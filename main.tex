...
Możemy też uzasadnić analogię między ideałem a podgrupą formalną w formalny sposób.
...
\begin{theorem}
	Niech $I$ będzie ideałem pierścienia przemiennego $\langle R, \oplus, \odot \rangle$. $\langle R/I, +, \times \rangle$, gdzie:
	\begin{itemize}[leftmargin=.5in]
		\item $(r \oplus I) \times (s \oplus I) = r \odot s \oplus I$,
...
\begin{proof}
	...
	\section{Pierwiastki z jedynki, wielomiany cyklotomiczne}
