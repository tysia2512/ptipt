...
% Wadą tego podejścia jest istnienie liczb pseudopierwszych Fermata, czyli liczb złożonych $p$, dla których dla pewnego $a$ zachodzi równanie małego twierdzenia Fermata. Z powodu na gęsty rozkład liczb pseudopierwszych Fermata, test Fermata nie jest 
...
% Ograniczenie złożoności wynika więc z wykorzystania uogólnionego małego twierdzenia Fermata nie w ciele $\mathbb{Z}_n}$, ale jego rozszerzeniu 
