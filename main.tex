...
\begin{theorem} \label{pier_ilo_cialem}
	Jeśli $p$ jest liczbą pierwszą i $h(X)$ jest nierozkładalnym w $\mathbb{Z}_p[X]$ wielomianem stopnia $d$, to pierścień ilorazowy $\langle \mathbb{Z}_p[X]/\langle h(X) \rangle, \oplus, \odot \rangle$ jest ciałem rzędu $p^d$.
\end{theorem}
